...
if (Object.keys(db_1.dbOps.getAllUsers()).length === 0) {
    console.log('Seeding database...');
    Object.values(initialUsers).forEach(user => db_1.dbOps.upsertUser(user));
    initialBooks.forEach(book => db_1.dbOps.addBook(book));
    initialChats.forEach(chat => db_1.dbOps.addChat(chat));
    Object.entries(initialMessages).forEach(([chatId, msgs]) => {
        msgs.forEach(msg => db_1.dbOps.addMessage(Object.assign(Object.assign({}, msg), { chatId })));
    });
